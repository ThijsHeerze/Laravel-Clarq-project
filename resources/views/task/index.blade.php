...
<body class="bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500">
    ...
    <div class="flex justify-end w-4/6">
        <a href="{{ route('tasks.create') }}" class="w-30 h-10 bg-white hover:text-green-600 mb-4 mr-10 p-2 flex justify-center rounded text-black hover:bg-gray-300 hover:text-white duration-300 hover:bg-opacity-20 animate-none">Create task</a>
    </div>
    <table class="flex justify-center">
        ...
        <tr class="bg-gray-200 bg-opacity-5">
            ...
            <td class="flex justify-center">
                <a href="{{ route('tasks.edit',$task->id)}}" class="w-2/4 bg-white hover:bg-gray-300 hover:text-white duration-300 hover:bg-opacity-20 p-2 ml-1 mr-1 rounded flex justify-center cursor-pointer">Edit</a>
                <form class="w-2/4 bg-white p-2 rounded flex justify-center cursor-pointer hover:bg-gray-300 hover:text-white duration-300 hover:bg-opacity-20" action="{{ route('tasks.destroy', $task->id) }}" method="post">
                    @csrf
                    @method('DELETE')
